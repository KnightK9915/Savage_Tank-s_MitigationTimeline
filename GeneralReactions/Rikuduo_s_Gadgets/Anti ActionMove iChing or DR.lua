		...
		data = 
		{
			...
			conditions = 
			{
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return (data._aam and data._aam.mode_select == \"iching\")\n",
		...
		data = 
		{
			...
			conditions = 
			{
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return (data._aam and data._aam.mode_select == \"pdr\")\n",
