					...
					
					{
						data = 
						{
							...
							conditions = 
							{
								...
								{
									"6ca7ff83-cd98-83c9-b662-14f1c9a203a3",
									true,
								},
				...
				conditions = 
				{
					...
					
					{
						data = 
						{
							...
							filterTargetType = "Enemy",
							uuid = "6ca7ff83-cd98-83c9-b662-14f1c9a203a3",
							version = 3,
						},
						inheritedIndex = 2,
					},
			...
			data = 
			{
				...
				conditions = 
				{
					...
					
					{
						...
						{
							category = "Lua",
							conditionLua = "if not Player or not Player:GetTarget() then\n    return false\nend\n\nlocal target = Player:GetTarget()\n\nif not target or not target.pos then\n    return false\nend\n\nlocal dx = Player.pos.x - target.pos.x\nlocal dz = Player.pos.z - target.pos.z\nlocal distance = math.sqrt(dx * dx + dz * dz)\n\nreturn distance > 3.0\n",
							name = "Out of Range",
							uuid = "02bc6c2f-b065-e7f1-8f27-b020e63eda65",
							version = 3,
						},
				...
				timerEndOffset = 5,
				timerStartOffset = -1,
				uuid = "4f0e1c0b-5167-8e34-831c-1cfcd80b4e61",
				version = 2,
			},
			inheritedIndex = 3,
		},
	...
	[28] = 
	{
		...
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -14.5,
				uuid = "5416e4dc-5443-1dec-a7be-ae3d78f4e0b6",
				version = 2,
			},
			inheritedIndex = 5,
		},
	...
	[52] = 
	{
		...
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -2.5,
				uuid = "839e5196-bb0e-cdd0-8b4b-4f07746a6736",
				version = 2,
			},
			inheritedIndex = 5,
		},
	...
	[90] = 
	{
		...
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -2.5,
				uuid = "89350645-afe1-b7f9-ac58-9fae17d5fcba",
				version = 2,
			},
			inheritedIndex = 5,
		},
	...
	[115] = 
	{
		...
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -2.5,
				uuid = "72cd9960-d49f-de4c-a9fb-f4460860bb70",
				version = 2,
			},
			inheritedIndex = 5,
		},
	...
	[131] = 
	{
		...
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -2.5,
				uuid = "784ed0fa-2798-039b-9c05-e6336f515b47",
				version = 2,
			},
			inheritedIndex = 5,
		},
	...
	[153] = 
	{
		...
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -2.5,
				uuid = "588aaa41-52bc-bd1e-befb-9758e76ce737",
				version = 2,
			},
			inheritedIndex = 5,
		},
	...
	[162] = 
	{
		...
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -2.5,
				uuid = "29ae711d-79d7-778f-a85a-d4eb5ab63e1e",
				version = 2,
			},
			inheritedIndex = 5,
		},
	...
	[163] = 
	{
		...
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -2.5,
				uuid = "a28bb0e9-b6bd-6859-84cc-1e8690ed8f44",
				version = 2,
			},
			inheritedIndex = 5,
		},
