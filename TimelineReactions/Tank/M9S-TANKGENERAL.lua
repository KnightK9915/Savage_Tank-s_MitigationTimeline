	...
	[6] = 
	{
		
		{
			data = 
			{
				...
				timerEndOffset = 8,
				timerStartOffset = -1,
				uuid = "c3ad31b2-9bcf-509f-885b-df78d87e61c8",
				version = 2,
			},
			inheritedIndex = 3,
		},
	...
	[9] = 
	{
		...
		
		{
			data = 
			{
				...
				timerEndOffset = 2,
				timerStartOffset = -1,
				uuid = "5ff46bf2-f928-b9da-a683-8e067befe42d",
				version = 2,
			},
		},
	},
	...
	[53] = 
	{
		...
		
		{
			data = 
			{
				...
				timerEndOffset = 15,
				timerStartOffset = -15,
				uuid = "cc78c2ac-c5c9-c3e4-a571-8b7662341d33",
				version = 2,
			},
			inheritedIndex = 3,
		},
	...
	[58] = 
	{
		
		{
			data = 
			{
				...
				timerEndOffset = 5,
				timerStartOffset = 0.10000000149012,
				uuid = "f0ef4626-00df-65be-8c3d-a494d9fb336f",
				version = 2,
			},
			inheritedIndex = 3,
		},
	...
	[62] = 
	{
		
		{
			data = 
			{
					...
					
					{
						data = 
						{
							...
							conditions = 
							{
								...
								{
									"73db5125-b84f-183d-84f9-d3675a92c52e",
									true,
								},
							},
							gVar = "ACR_TensorWeeb3_CD",
				...
				conditions = 
				{
					...
					
					{
						data = 
						{
							...
							conditionLua = "local me = Player\nif not me then return false end\n\nlocal list = EntityList(\"contentid=14300\") or {}\nlocal found = false\n\nfor _, e in pairs(list) do\n    if e and e.id ~= 0 then\n        found = true\n        if e.targetid == me.id then\n            return false\n        end\n    end\nend\n\nreturn found\n",
							name = "Vamp not targeting self",
							uuid = "73db5125-b84f-183d-84f9-d3675a92c52e",
							version = 3,
						},
						inheritedIndex = 3,
					},
				...
				timerEndOffset = 8,
				timerStartOffset = -1,
				uuid = "73ceceb7-ed80-557e-a5c3-12b1e76a2004",
				version = 2,
			},
			inheritedIndex = 3,
		},
	...
	[68] = 
	{
		...
		
		{
			data = 
			{
				...
				timelineIndex = 68,
				timerEndOffset = 2,
				uuid = "44799673-20f6-5238-9080-4c5db7cce2f4",
				version = 2,
			},
		},
	},
	...
	[178] = 
	{
		...
		
		{
			data = 
			{
				...
				timelineIndex = 178,
				timerEndOffset = 2,
				uuid = "fad101ac-e107-a340-85ff-9bd74a41735c",
				version = 2,
			},
		},
	},
	[181] = 
	{
		
		{
			data = 
			{
					...
					
					{
						data = 
						{
							...
							conditions = 
							{
								...
								{
									"e636130f-f838-19a0-b4fa-9836ecb4ceb9",
									true,
								},
							},
							gVar = "ACR_TensorWeeb3_CD",
				...
				conditions = 
				{
					...
					
					{
						data = 
						{
							...
							conditionLua = "local me = Player\nif not me then return false end\n\nlocal list = EntityList(\"contentid=14300\") or {}\nlocal found = false\n\nfor _, e in pairs(list) do\n    if e and e.id ~= 0 then\n        found = true\n        if e.targetid == me.id then\n            return false\n        end\n    end\nend\n\nreturn found\n",
							name = "Vamp not targeting self",
							uuid = "e636130f-f838-19a0-b4fa-9836ecb4ceb9",
							version = 3,
						},
						inheritedIndex = 3,
					},
				...
				timerEndOffset = 8,
				timerStartOffset = -1,
				uuid = "575b16d1-5ebe-f52f-b280-5fff79e78649",
				version = 2,
			},
			inheritedIndex = 3,
		},
	...
	[187] = 
	{
		
		{
			data = 
			{
				...
				timerEndOffset = 5,
				timerStartOffset = 0.10000000149012,
				uuid = "b47c5d1e-c462-7fec-beba-edbc98ac21f6",
				version = 2,
			},
			inheritedIndex = 3,
		},
